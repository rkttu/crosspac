...
theme: default
paginate: true
footer: 'Crosspac · Introduction for Azure Presales'
title: 'Crosspac — A Cross-Platform Desktop Client for Power Platform CLI'
...
<!--
Speaker: One-minute framing — Crosspac is a thin, transparent GUI over the pac CLI.
...
> Design principle: **wrap, don't reinvent.** Crosspac is `git`/`kubectl` for pac — it drives and observes, it isn't a new IDE.
...
<div class="mock">
  <div class="bar">Crosspac — Power Platform CLI</div>
...
```
 Crosspac.App  (Avalonia, MVVM)  ──►  Crosspac.Core  (no UI)
                                         │
                                         ▼
...
> Honesty sells: Crosspac is the **deploy/manage/observe** surface, not a new authoring studio.
...
**Crosspac** = a transparent, cross-platform GUI over `pac`
...
<span class="muted">Rendering: VS Code "Marp for VS Code" extension, or <code>marp docs/slides/crosspac-azure-presales.md --pdf</code>.</span>
